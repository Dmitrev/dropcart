...
if (!empty($_POST) AND !empty($intId)) {
    ...
    if (empty($product_price_from)) {
        ...
        // adds single quotes
        $product_price_from = "'" . $product_price_from . "'";
    }
    ...
    // merges seperate input fields into one array for easier looping
    $arrTiers = array_combine($arrTiersQuantity, $arrTiersPercentage);
...
?>
    ...
    <h1>Product details
        <small><?php if (isset($intId) && $intId != 0) {
                $intId;
            } ?></small>
    </h1>
...
if (!empty($_GET['succes'])) {
    echo '<div class="alert alert-success">
                ...
                <strong>Gelukt!</strong> ' . $_GET['succes'] . '
          </div>';
}
...
<?php else : ?>
    <div class="col-md-8">
        ...
        <div class="alert alert-warning" role="alert">
            <strong>Let op</strong>: Indien een veld niet ingevuld is wordt de
            informatie uit de API of Boilerplate content gehaald.
        </div>

        <div class="panel panel-default">
            <div class="panel-heading">Product eigenschappen</div>
            <!-- /panel-heading -->
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text"
                                   ...
                                   name="product_title"
                                   value="<?php
                                    if (isset($objProduct->title)) {
                                       echo $objProduct->title;
                                   } ?>"
                                   autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control"
                                      ...
                                      rows="7"><?php
                                            if (isset($objProduct->description)) {
                                                echo $objProduct->description;
                                            }
                                    ?></textarea>
                        </div>
                        <!-- /col -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="product_price_from" name="product_price_from"
                                   value="<?php
                                       if (isset($objProduct->price_from)) {
                                           $objProduct->price_from;
                                       }
                                   ?>"
                                   autocomplete="off">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text"
                                   ...
                                   name="product_price"
                                   value="<?php
                                        if (isset($objProduct->price)) {
                                            echo $objProduct->price;
                                         }
                                   ?>"
                                   autocomplete="off">

                            <p class="help-block">Overschrijf standaard prijsformule. Verplicht voor het invullen van
                                volume prijzen.</p>

                            <p class="help-block">Geldige values: <code>price</code> = Inktweb.nl prijs, inclusief BTW,
                                <code>purchase</code> = Inkoopprijs exclusief BTW, <code>msrp</code> = Adviesprijs
                                exclusief BTW.</p>
                        </div>
                        <!-- /col -->
                    ...
                    <div id="productTiers">
                        <div class="col-sm-6 col-sm-offset-4"><p class="help-block">Volume prijzen. Vul in het eerste
                                veld vanaf welk aantal (bijvoorbeeld &ldquo;3&rdquo;) en in het tweede veld het
                                percentage korting wat gegeven wordt (bijvoorbeeld &ldquo;5&rdquo;).</p></div>
                        <!-- /col -->
                        ...
                        $strSQL = "SELECT
                                      quantity,
                                      percentage
                                  FROM " . DB_PREFIX . "products_tiered
                        ...
                        if ($numTiers > 0) {
                            while ($objTier = $objDB->getObject($result)) {
                                ...
                                <div class="form-group">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <label for="product_price_tiers_qty"
                                               class="col-sm-3 control-label">Vanaf</label>

                                        <div class="col-sm-3">
                                            <input type="number" min="1" class="form-control"
                                                   id="product_price_tiers_qty" name="product_price_tiers_qty[]"
                                                   value="<?= $objTier->quantity; ?>" autocomplete="off">
                                        </div>
                                        <!-- /col -->
                                        <label for="product_price_tiers_percentage"
                                               class="col-sm-3 control-label">Percentagekorting</label>

                                        <div class="col-sm-3">
                                            <input type="number" min="1" class="form-control"
                                                   id="product_price_tiers_percentage"
                                                   name="product_price_tiers_percentage[]"
                                                   value="<?= $objTier->percentage; ?>" autocomplete="off">
                                        </div>
                                        <!-- /col -->
                                    </div>
                                    <!-- /col -->
                            ...
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-2">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" min="1" class="form-control" id="product_price_tiers_qty"
                                               name="product_price_tiers_qty[]" autocomplete="off">
                                    </div>
                                    <!-- /col -->
                                    <label for="product_price_tiers_percentage"
                                           class="col-sm-3 control-label">Percentagekorting</label>
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" min="1" class="form-control"
                                               id="product_price_tiers_percentage"
                                               name="product_price_tiers_percentage[]" autocomplete="off">
                                    </div>
                                    <!-- /col -->
                                </div>
                                <!-- /col -->
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label for="check_cart">
                                    <input type="checkbox"
                                           name="check_cart"
                                           id="check_cart"
                                           value="1" <?php
                                            if (isset($objProduct->opt_cart) && $objProduct->opt_cart == "1") {
                                                echo 'checked';
                                            }
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label for="check_top5">
                                    <input type="checkbox"
                                           name="check_top5"
                                           id="check_top5"
                                           value="1" <?php
                                                if (isset($objProduct) && $objProduct->opt_top5 == "1") {
                                                    echo 'checked';
        ...
        <p>
            <a  href="https://www.inktweb.nl/products_detail.php?id=<?php echo $intId; ?>"
                class="btn btn-default">
                Bekijkop Inktweb.nl
            </a>
            <a href="<?php echo SITE_URL ?>/product/<?php echo $intId; ?>/" class="btn btn-primary">Bekijk op
                website</a>
        </p>
    ...
    <div class="col-md-4">
        <div class="list-group">
            ...
            <a class="list-group-item">
                ...
                <p class="list-group-item-text"><?php echo (isset($objPrice->pricePurchase)) ?
                        $objPrice->pricePurchase : '<i> niet beschikbaar</i>'; ?></p>
            </a>
            ...
            <a class="list-group-item">
                ...
                <small>Incl. BTW.</small>
                <p class="list-group-item-text"><?php echo (isset($objPrice->priceMSRP)) ? $objPrice->priceMSRP :
                        '<i> niet beschikbaar</i>'; ?></p>
            </a>

            <a class="list-group-item">
                <h4 class="list-group-item-heading">Price
                    <span class="label label-primary"title="De prijs die momenteel op de website staat.">LIVE</span>
                </h4>
                <small>Incl. BTW.</small>
    ...
    <script type="text/javascript"
            src="<?php echo SITE_URL ?>/beheer/includes/script/jquery.pagedown-bootstrap.combined.min.js"></script>
    <script type="text/javascript">
        (function () {
